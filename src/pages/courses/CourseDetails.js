...
function CourseDetails() {
  ...
  const [status,setStatus] = useState('init');
    ...
    const init =()=>{
        setStatus('loading')
      return axios.get('http://questence.tqfe.net/api/v1/courses/1').then(response => {
                            ...
                            <Col lg="9" md="8" sm="12">
                                <div className="course-details-top">
                                    <div className="heading">
                                        ...
                                        <h4> {coursedetails && coursedetails.data ? coursedetails.data.course_name :''}.</h4>
                                    </div>
                                    <div className="course-top-overview">
                                        <div className="d-flex overviews">
                                            ...
                                            <div className="price">
                                                <h6>Price</h6>
                                                <p>${coursedetails && coursedetails.data ? coursedetails.data.course_fee :''}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="course-details-banner">
                                        <img src={`${coursedetails && coursedetails.data ? coursedetails.data.course_cover_image :''}`} alt="No Image" className="img-fluid" />
                                    </div>
                                            ...
                                            <Tab.Content>
                                                <Tab.Pane eventKey="overview" className="overview-tab">
                                                    <div className="course-desc">
                                                        ...
                                                        <p> {coursedetails && coursedetails.data ? coursedetails.data.course_description :''}</p>
                                                    </div>
                                            ...
                                            <div className="course-details-feature">
                                                <h5 className="title">Course Details</h5>
                                                  ...
                                                  <ul className="list-unstyled feature-list">
                                                    <li><i className="las la-calendar"></i> Start Date: <span> 
                                                    {moment(`${coursedetails && coursedetails.data ? coursedetails.data.start_date :''}`).format("ll")}
                                                        
                                                         </span></li>
                                                    <li><i className="las la-clock"></i> Duration: <span>  {coursedetails && coursedetails.data ? coursedetails.data.duration :''}</span></li>
